...
class MessageFormatter:
    ...
    def format_ayuda(self) -> str:
        ...
        return (
            ...
            "**Funcionalidades:**\n"
            f"{BotConstants.SUCCESS} Balance diario y mensual\n"
            f"{BotConstants.SUCCESS} Categorías personalizables\n"
            f"{BotConstants.SUCCESS} Suscripciones automáticas\n"
            f"{BotConstants.SUCCESS} Recordatorios inteligentes\n"
            f"{BotConstants.SUCCESS} Control de deudas\n"
            f"{BotConstants.SUCCESS} Alertas de gastos\n\n"
